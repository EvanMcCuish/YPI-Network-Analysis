...
# Input:
vars <- c("Charm", "Grand", "Lying", "Manip", "Remors", "Unemo", "Callous", "Thrill", "Imp",
          "Irresp", "Versatility")
idvar <- "CASEID"

#######FOR THE BELOW, subjectNetworks = FALSE is to avoid estimating individual networks. 
...
centrality_auto(res_GVAR$betweenNet)
centrality_auto(res_GVAR$fixedPDC)
centrality_auto(res_GVAR$fixedPCC)
